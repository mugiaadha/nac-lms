...
class InstructorController extends Controller
{
    ...
    {
        return view('backoffice.instructor.dashboard');
    }

    public function profile()
    {
        $profile = auth()->user();
        return view('backoffice.instructor.profile', compact('profile'));
    }
    ...
    {
        return view('backoffice.instructor.login');
    }
    ...
    public function changePassword()
    {
        $profileId = auth()->user()->id;
        $profile = User::findOrFail($profileId);
        return view('backoffice.instructor.change_password', compact('profile'));
    }
