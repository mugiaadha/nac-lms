...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('frontoffice/css/tooltipster.bundle.css') }}">
...
<body>
    ...
    <!--======================================
        START HEADER AREA
    ======================================-->
    @include('frontoffice.layouts.parts.header')
    ...
    <!-- ================================
         END FOOTER AREA
    ================================= -->
    @include('frontoffice.layouts.parts.footer')
    <!-- end footer-area -->
    <!-- ================================
          END FOOTER AREA
    =============================== -->
    ...
    <script src="{{ asset('frontoffice/js/waypoint.min.js') }}"></script>
    ...
    <script src="{{ asset('frontoffice/js/tooltipster.bundle.min.js') }}"></script>
    <script src="{{ asset('frontoffice/js/jquery.lazy.min.js') }}"></script>
