      ...
      <div class="card card-item">
        <div class="card-image">
          <a href="blog-single.html" class="d-block">
            <img
              class="card-img-top"
              src="{{ asset('frontoffice/images/img8.jpg') }}"
              alt="Card image cap"
            />
          </a>
      ...
      <div class="card card-item">
        <div class="card-image">
          <a href="blog-single.html" class="d-block">
            <img
              class="card-img-top"
              src="{{ asset('frontoffice/images/img9.jpg') }}"
              alt="Card image cap"
            />
          </a>
          <div class="course-badge-labels">
        ...
        <div class="card-body">
          <h5 class="card-title">
            <a href="blog-single.html"
              >Ultimate Photoshop Training: From Beginner</a
            >
          </h5>
          <ul
            class="generic-list-item generic-list-item-bullet generic-list-item--bullet d-flex align-items-center flex-wrap fs-14 pt-2"
      ...
      <div class="card card-item">
        <div class="card-image">
          <a href="blog-single.html" class="d-block">
            <img
              class="card-img-top"
              src="{{ asset('frontoffice/images/img10.jpg') }}"
              alt="Card image cap"
            />
          </a>
          <div class="course-badge-labels">
      ...
      <div class="card card-item">
        <div class="card-image">
          <a href="blog-single.html" class="d-block">
            <img
              class="card-img-top"
              src="{{ asset('frontoffice/images/img11.jpg') }}"
              alt="Card image cap"
            />
          </a>
          <div class="course-badge-labels">
      ...
      <div class="card card-item">
        <div class="card-image">
          <a href="blog-single.html" class="d-block">
            <img
              class="card-img-top"
              src="{{ asset('frontoffice/images/img12.jpg') }}"
              alt="Card image cap"
            />
          </a>
          <div class="course-badge-labels">
      ...
      <div class="card card-item">
        <div class="card-image">
          <a href="blog-single.html" class="d-block">
            <img
              class="card-img-top"
              src="{{ asset('frontoffice/images/img13.jpg') }}"
              alt="Card image cap"
            />
          </a>
          <div class="course-badge-labels">
