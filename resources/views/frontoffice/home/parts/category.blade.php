            ...
            <div class="row">
                <div class="col-lg-4 responsive-column-half">
                    <div class="category-item">
                        <img class="cat__img lazy" src="{{ asset('frontoffice/images/img-loading.png') }}" data-src="{{ asset('frontoffice/images/img1.jpg') }}" alt="Category image">
                ...
                <div class="col-lg-4 responsive-column-half">
                    <div class="category-item">
                        <img class="cat__img lazy" src="{{ asset('frontoffice/images/img-loading.png') }}" data-src="{{ asset('frontoffice/images/img2.jpg') }}" alt="Category image">
                        <div class="category-content">
                            <div class="category-inner">
                ...
                <div class="col-lg-4 responsive-column-half">
                    <div class="category-item">
                        <img class="cat__img lazy" src="{{ asset('frontoffice/images/img-loading.png') }}" data-src="{{ asset('frontoffice/images/img3.jpg') }}" alt="Category image">
                        <div class="category-content">
                            <div class="category-inner">
                ...
                <div class="col-lg-4 responsive-column-half">
                    <div class="category-item">
                        <img class="cat__img lazy" src="{{ asset('frontoffice/images/img-loading.png') }}" data-src="{{ asset('frontoffice/images/img4.jpg') }}" alt="Category image">
                        <div class="category-content">
                            <div class="category-inner">
                ...
                <div class="col-lg-4 responsive-column-half">
                    <div class="category-item">
                        <img class="cat__img lazy" src="{{ asset('frontoffice/images/img-loading.png') }}" data-src="{{ asset('frontoffice/images/img5.jpg') }}" alt="Category image">
                        <div class="category-content">
                            <div class="category-inner">
                ...
                <div class="col-lg-4 responsive-column-half">
                    <div class="category-item">
                        <img class="cat__img lazy" src="{{ asset('frontoffice/images/img-loading.png') }}" data-src="{{ asset('frontoffice/images/img6.jpg') }}" alt="Category image">
                        <div class="category-content">
                            <div class="category-inner">
