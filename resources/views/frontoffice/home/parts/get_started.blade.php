    ...
    <div class="row">
      <div class="col-lg-4 responsive-column-half">
        <div class="card card-item hover-s text-center">
          <div class="card-body">
            <img
              src="{{ asset('frontoffice/images/img-loading.png') }}"
              data-src="{{ asset('frontoffice/images/small-img-2.jpg') }}"
              alt="card image"
              class="img-fluid rounded-full lazy"
            />
            <h5 class="card-title pt-4 pb-2">Become an Instructor</h5>
            <p class="card-text">
              Teach what you love. Aduca gives you the tools to create a course.
            </p>
            <div class="btn-box mt-20px">
              <a
                href="become-a-teacher.html"
                class="btn theme-btn theme-btn-sm theme-btn-white lh-30"
                ><i class="la la-user mr-1"></i>Start Teaching</a
              >
            </div>
            <!-- end btn-box -->
          </div>
      ...
      <div class="col-lg-4 responsive-column-half">
        <div class="card card-item hover-s text-center">
          <div class="card-body">
            <img
              src="{{ asset('frontoffice/images/img-loading.png') }}"
              data-src="{{ asset('frontoffice/images/small-img-3.jpg') }}"
              alt="card image"
              class="img-fluid rounded-full lazy"
            />
            ...
            <div class="btn-box mt-20px">
              <a
                href="admission.html"
                class="btn theme-btn theme-btn-sm theme-btn-white lh-30"
                ><i class="la la-file-text-o mr-1"></i>Start Learning</a
              >
            </div>
            <!-- end btn-box -->
          </div>
      ...
      <div class="col-lg-4 responsive-column-half">
        <div class="card card-item hover-s text-center">
          <div class="card-body">
            <img
              src="{{ asset('frontoffice/images/img-loading.png') }}"
              data-src="{{ asset('frontoffice/images/small-img-4.jpg') }}"
              alt="card image"
              class="img-fluid rounded-full lazy"
            />
            <h5 class="card-title pt-4 pb-2">Aduca for Business</h5>
            <p class="card-text">
              Get unlimited access to 5,000+ of Aduca's top courses for your
              team
            </p>
            <div class="btn-box mt-20px">
              <a
                ...
                class="btn theme-btn theme-btn-sm theme-btn-white lh-30"
                ><i class="la la-briefcase mr-1"></i>Get aduca for business</a
              >
            </div>
            <!-- end btn-box -->
          </div>
