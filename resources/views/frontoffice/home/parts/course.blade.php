<section class="course-area pb-120px">
  <div class="container">
    ...
    <!-- end section-heading -->
    <ul
      class="nav nav-tabs generic-tab justify-content-center pb-4"
      id="myTab"
      role="tablist"
    >
      <li class="nav-item">
                ...
                <div class="card-image">
                  <a href="course-details.html" class="d-block">
                    <img
                      ...
                      data-src="{{ asset('frontoffice/images/img8.jpg') }}"
                      alt="Card image cap"
                    />
                  </a>
                ...
                <div class="card-image">
                  <a href="course-details.html" class="d-block">
                    <img
                      class="card-img-top lazy"
                      src="{{ asset('frontoffice/images/img-loading.png') }}"
                      data-src="{{ asset('frontoffice/images/img9.jpg') }}"
                      alt="Card image cap"
                    />
                  </a>
                  <div class="course-badge-labels">
                ...
                <div class="card-image">
                  <a href="course-details.html" class="d-block">
                    <img
                      class="card-img-top lazy"
                      src="{{ asset('frontoffice/images/img-loading.png') }}"
                      data-src="{{ asset('frontoffice/images/img10.jpg') }}"
                      alt="Card image cap"
                    />
                  </a>
                </div>
                ...
                <div class="card-image">
                  <a href="course-details.html" class="d-block">
                    <img
                      class="card-img-top lazy"
                      src="{{ asset('frontoffice/images/img-loading.png') }}"
                      data-src="{{ asset('frontoffice/images/img11.jpg') }}"
                      alt="Card image cap"
                    />
                  </a>
                </div>
                ...
                <div class="card-image">
                  <a href="course-details.html" class="d-block">
                    <img
                      class="card-img-top lazy"
                      src="{{ asset('frontoffice/images/img-loading.png') }}"
                      data-src="{{ asset('frontoffice/images/img12.jpg') }}"
                      alt="Card image cap"
                    />
                  </a>
                  <div class="course-badge-labels">
                ...
                <div class="card-image">
                  <a href="course-details.html" class="d-block">
                    <img
                      class="card-img-top lazy"
                      src="{{ asset('frontoffice/images/img-loading.png') }}"
                      data-src="{{ asset('frontoffice/images/img13.jpg') }}"
                      alt="Card image cap"
                    />
                  </a>
                  <div class="course-badge-labels">
            ...
            <div class="col-lg-4 responsive-column-half">
              ...
              >
                ...
                <div class="card-body">
                  ...
                  <h5 class="card-title">
                    <a href="course-details.html"
                      >Ultimate Adobe Photoshop Training: From Beginner to
                      Pro</a
                    >
                  </h5>
                  <p class="card-text">
            ...
            <div class="col-lg-4 responsive-column-half">
              ...
              >
                ...
                <div class="card-body">
                  ...
                  <h5 class="card-title">
                    <a href="course-details.html"
                      >The Ultimate Drawing Course - Beginner to Advanced</a
                    >
                  </h5>
                  <p class="card-text">
                    <a href="teacher-detail.html">Jose Portilla</a>
