        ...
        <div class="testimonial-carousel owl-action-styled">
                ...
                <div class="card-body">
                    <div class="media media-card align-items-center pb-3">
                        <div class="media-img avatar-md">
                            <img src="{{ asset('frontoffice/images/small-avatar-1.jpg') }}" alt="Testimonial avatar" class="rounded-full">
                        </div>
            ...
            <div class="card card-item">
                <div class="card-body">
                    <div class="media media-card align-items-center pb-3">
                        <div class="media-img avatar-md">
                            <img src="{{ asset('frontoffice/images/small-avatar-2.jpg') }}" alt="Testimonial avatar" class="rounded-full">
                        </div>
                        <div class="media-body">
            ...
            <div class="card card-item">
                <div class="card-body">
                    <div class="media media-card align-items-center pb-3">
                        <div class="media-img avatar-md">
                            <img src="{{ asset('frontoffice/images/small-avatar-3.jpg') }}" alt="Testimonial avatar" class="rounded-full">
                        </div>
                        <div class="media-body">
                            <h5>Jackob Hallac</h5>
                            <div class="d-flex align-items-center pt-1">
            ...
            <div class="card card-item">
                <div class="card-body">
                    <div class="media media-card align-items-center pb-3">
                        <div class="media-img avatar-md">
                            <img src="{{ asset('frontoffice/images/small-avatar-4.jpg') }}" alt="Testimonial avatar" class="rounded-full">
                        </div>
                        <div class="media-body">
                            <h5>Lubic Duble</h5>
                            <div class="d-flex align-items-center pt-1">
            ...
            <div class="card card-item">
                <div class="card-body">
                    <div class="media media-card align-items-center pb-3">
                        <div class="media-img avatar-md">
                            <img src="{{ asset('frontoffice/images/small-avatar-5.jpg') }}" alt="Testimonial avatar" class="rounded-full">
                        </div>
                        <div class="media-body">
                            <h5>Daniel Ward</h5>
                            <div class="d-flex align-items-center pt-1">
