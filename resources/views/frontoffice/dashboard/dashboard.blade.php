@extends('frontoffice.layouts.inner_app_layout')

@section('content')
<div class="breadcrumb-content d-flex flex-wrap align-items-center justify-content-between mb-5">
    <div class="media media-card align-items-center">
        <div class="media-img media--img media-img-md rounded-full">
            <img class="rounded-full" src="{{ asset('frontoffice/images/small-avatar-1.jpg') }}" alt="Student thumbnail image">
        </div>
        ...
        <div class="card card-item dashboard-info-card">
            <div class="card-body d-flex align-items-center">
                <div class="icon-element flex-shrink-0 bg-6 text-white">
                    <svg class="svg-icon-color-white" width="40" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
                        <g>
                            <g>
