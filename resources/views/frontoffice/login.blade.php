                        ...
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="input-box">
                                ...
                                <div class="form-group">
                                    <input class="form-control form--control @error('email') is-invalid @enderror" type="email" name="email" placeholder="Email">
                            ...
                            <div class="input-box">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input class="form-control form--control password-field @error('password') is-invalid @enderror" type="password" name="password" placeholder="Password">
