@extends('instructor.layouts.inner_app_layout')
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex flex-column align-items-center text-center">
                                    <img src="{{ !empty($profile->photo) ? asset('storage/'.$profile->photo) : asset('backoffice/images/avatars/no-image.png') }}" alt="Admin" class="rounded-circle p-1 bg-primary" width="110" height="110">
                                    <div class="mt-3">
                                        <h4>{{ $profile->name }}</h4>
                            ...
                            <form action="{{ route('instructor.profile.update') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <textarea name="address" id="" class="form-control">{{ $profile->address }}</textarea>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-sm-3">
