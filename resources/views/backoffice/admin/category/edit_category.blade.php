                ...
                <div class="card">
                    <div class="card-body p-4">
                        ...
                        <form class="row g-3" action="{{ route('category.update') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-md-12">
                                <img src="{{ !empty($category->category_image) ? asset('storage/'.$category->category_image) : asset('backoffice/images/avatars/no-image.png') }}" alt="Admin" class="rounded-circle p-1 bg-primary" width="110" height="110" show-image>
                            </div>
                            <div class="col-md-12">
